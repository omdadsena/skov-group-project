  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bottom-20 right-4 md:bottom-24 md:right-6 z-40 flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-full bg-skov-gold text-skov-black shadow-gold"
        aria-label="Chatbot"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-36 right-4 left-4 w-auto max-w-full md:left-auto md:right-6 md:w-[340px] md:bottom-40 z-50 flex h-[calc(100vh-180px)] max-h-[460px] flex-col overflow-hidden rounded-2xl border border-skov-gold/30 bg-skov-black/95 shadow-gold backdrop-blur-xl"
          >
